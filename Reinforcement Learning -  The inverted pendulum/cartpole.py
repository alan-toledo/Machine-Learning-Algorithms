...
from functions import initialize_mdp_data, choose_action, update_mdp_transition_counts_sum_reward, update_mdp_transition_probs_avg_reward, update_mdp_value
...
Briefly, the cart-pole system is described in `cartpole.py`. The main
...
def main():
    ...
    while consecutive_no_learning_trials < NO_LEARNING_THRESHOLD:
        ...
        if new_state == NUM_STATES - 1:
            ...
            update_mdp_value(mdp_data, TOLERANCE, GAMMA)
            consecutive_no_learning_trials = 0
